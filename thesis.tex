...
% arara: clean: {files: [thesis.bbl, thesis.aux, thesis.toc]}
% arara: xelatex
% arara: nomencl
% arara: biber
% arara: biber
% arara: xelatex
% arara: xelatex
% arara: clean: {files: [thesis.out, thesis.toc, thesis.lot, thesis.lof, thesis.bbl, thesis.nls, thesis.nlo, thesis.aux, thesis.idx, thesis.ilg, thesis.ind, thesis.bbl, thesis.bcf, thesis.ist, thesis.blg, thesis.run.xml, thesis.fdb_latexmk, thesis.fls]}
%
%
%
